...
export function ModelSelector() {
  ...
  const modelData = {
    ...
    "iPhone 15 Pro": {
      image: "/images/models/apple/15-pro.webp",
      screen: [
        { name: "Замена экрана", price: "от 12 500 сом" },
        { name: "Замена стекла", price: "от 7 800 сом" },
        { name: "Замена Face ID", price: "от 8 900 сом" },
      ],
      battery: [
        { name: "Замена батареи", price: "от 3 900 сом" },
        { name: "Диагностика батареи", price: "Бесплатно" },
      ],
      other: [
        { name: "Замена камеры", price: "от 5 500 сом" },
        { name: "Замена разъема зарядки", price: "от 3 200 сом" },
        { name: "Ремонт после воды", price: "от 6 900 сом" },
      ],
    },
    "iPhone 15": {
      image: "/images/models/apple/15.webp",
      screen: [
        { name: "Замена экрана", price: "от 10 800 сом" },
        { name: "Замена стекла", price: "от 6 900 сом" },
        { name: "Замена Face ID", price: "от 7 900 сом" },
      ],
      battery: [
        { name: "Замена батареи", price: "от 3 500 сом" },
        { name: "Диагностика батареи", price: "Бесплатно" },
      ],
      other: [
        { name: "Замена камеры", price: "от 4 900 сом" },
        { name: "Замена разъема зарядки", price: "от 2 900 сом" },
        { name: "Ремонт после воды", price: "от 5 900 сом" },
      ],
    },
    "iPhone 14 Pro": {
      image: "/images/models/apple/14-pro.webp",
      screen: [
        { name: "Замена экрана", price: "от 11 500 сом" },
        { name: "Замена стекла", price: "от 7 200 сом" },
        { name: "Замена Face ID", price: "от 8 500 сом" },
      ],
      battery: [
        { name: "Замена батареи", price: "от 3 700 сом" },
        { name: "Диагностика батареи", price: "Бесплатно" },
      ],
      other: [
        { name: "Замена камеры", price: "от 5 200 сом" },
        { name: "Замена разъема зарядки", price: "от 3 000 сом" },
        { name: "Ремонт после воды", price: "от 6 500 сом" },
      ],
    },
    "iPhone 14": {
      image: "/images/models/apple/14.webp",
      screen: [
        { name: "Замена экрана", price: "от 9 800 сом" },
        { name: "Замена стекла", price: "от 6 500 сом" },
        { name: "Замена Face ID", price: "от 7 500 сом" },
      ],
      battery: [
        { name: "Замена батареи", price: "от 3 300 сом" },
        { name: "Диагностика батареи", price: "Бесплатно" },
      ],
      other: [
        { name: "Замена камеры", price: "от 4 700 сом" },
        { name: "Замена разъема зарядки", price: "от 2 700 сом" },
        { name: "Ремонт после воды", price: "от 5 500 сом" },
      ],
    },
    "iPhone 13": {
      image: "/images/models/apple/13.webp",
      screen: [
        { name: "Замена экрана", price: "от 8 900 сом" },
        { name: "Замена стекла", price: "от 5 900 сом" },
        { name: "Замена Face ID", price: "от 6 900 сом" },
      ],
      battery: [
        { name: "Замена батареи", price: "от 3 100 сом" },
        { name: "Диагностика батареи", price: "Бесплатно" },
      ],
      other: [
        { name: "Замена камеры", price: "от 4 300 сом" },
        { name: "Замена разъема зарядки", price: "от 2 500 сом" },
        { name: "Ремонт после воды", price: "от 5 100 сом" },
      ],
    },
    "iPhone SE": {
      image: "/images/models/apple/se.webp",
      screen: [
        { name: "Замена экрана", price: "от 5 900 сом" },
        { name: "Замена стекла", price: "от 3 900 сом" },
        { name: "Замена Touch ID", price: "от 4 500 сом" },
      ],
      battery: [
        { name: "Замена батареи", price: "от 2 500 сом" },
        { name: "Диагностика батареи", price: "Бесплатно" },
